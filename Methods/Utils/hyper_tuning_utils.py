...
def _objective(params_dict, hype_tuning_config, hyper_args):    
	...
	# we tune sparsity, but set p_in equal to sparsity in some of our experiments
	if "sparsity" in hyper_args:
		hyper_args["p_in"] = hyper_args["sparsity"]
	params_dict.update(hyper_args)
	# print("Hyperparameters used for this trial: ", params_dict)
