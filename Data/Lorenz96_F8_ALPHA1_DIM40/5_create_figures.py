...
for N_plot in [1000, 10000, 100000]:
    ...
    # Saving the Plot
    plt.savefig(base_path + "/Figures/Plot_U_first_N{:d}.png".format(N_plot), bbox_inches="tight", dpi = 300)
    plt.close()
...
for N_plot in [1000, 10000, 100000]:
    ...
    plt.xlabel(r"$x$")
    plt.ylabel(r"$n, \quad t=n \cdot {:}$".format(dt))
    plt.savefig(base_path + "/Figures/Plot_U_last_N{:d}.png".format(N_plot), bbox_inches="tight", dpi = 300)
    plt.close()
