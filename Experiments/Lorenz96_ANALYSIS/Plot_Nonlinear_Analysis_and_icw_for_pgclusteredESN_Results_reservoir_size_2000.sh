...
--parse_string  "round_(\d+)_grid-search-for-nonlinearity&icw_(\d+\.\d+)_reservoir_size_2000-pgclustered_esn_system_name_Lorenz96_F8_ALPHA(\d+)_DIM40_reservoir_size_2000_NTrain_100000_Noise_5_Regularization_(\d+\.\d+)" \
