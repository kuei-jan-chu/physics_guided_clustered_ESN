...
--parse_string  "round_(\d+)_grid-search-for-nonlinearity&icw_(\d+\.\d+)-pgclustered_esn_system_name_Lorenz96_F8_ALPHA(\d+)_DIM40_reservoir_size_3000_NTrain_100000_Noise_5_Regularization_(\d+\.\d+)" \
