...
DEFAULT_PROB_WRONG_COUPLINGS=0.1
...
PROB_WRONG_COUPLINGS=${7:-$DEFAULT_PROB_WRONG_COUPLINGS}
...
python3 RUN.py partially_pgclustered_esn \
--mode $MODE \
--display_output 0 \
--worker_id 0 \
...
--prob_wrong_couplings $PROB_WRONG_COUPLINGS \
